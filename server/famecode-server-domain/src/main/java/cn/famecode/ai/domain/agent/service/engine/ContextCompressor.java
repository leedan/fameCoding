package cn.famecode.ai.domain.agent.service.engine;

import cn.famecode.ai.domain.agent.service.context.reducer.HybridReducer;
import cn.famecode.ai.domain.agent.service.context.reducer.MessageReducer;
import cn.famecode.ai.domain.agent.service.context.reducer.PriorityReducer;
import cn.famecode.ai.domain.agent.service.context.reducer.SlidingWindowReducer;
...
/**
 * 上下文压缩器
 * <p>对标 FameCode contextCompressor.ts
 * <p>
 * 触发条件：
