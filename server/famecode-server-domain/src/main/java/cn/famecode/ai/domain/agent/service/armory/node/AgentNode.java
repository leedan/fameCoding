...
import cn.famecode.ai.domain.agent.service.armory.matter.tools.BuildValidationAdkTool;
import cn.famecode.ai.domain.agent.service.armory.matter.tools.CodeEditAdkTool;
import cn.famecode.ai.domain.agent.service.armory.matter.tools.LocalExecuteAdkTool;
...
import cn.famecode.ai.domain.agent.service.armory.matter.patch.MySpringAI;
    ...
    protected AiAgentRegisterVO doApply(ArmoryCommandEntity requestParameter, DefaultArmoryFactory.DynamicContext dynamicContext) throws Exception {
        ...
        for (AiAgentConfigTableVO.Module.Agent agentConfig : agents) {
            LlmAgent.Builder builder = LlmAgent.builder()
                    ...
                    .model(new MySpringAI(chatModel, (StreamingChatModel) chatModel, chatModelConfig.getModel()))
