package cn.famecode.ai.domain.agent.service.task;

import cn.famecode.ai.domain.agent.model.valobj.task.TaskBreakdownVO;
import cn.famecode.ai.domain.agent.service.ITaskBreakdownService;
    ...
    public void init() {
        try {
            cn.famecode.ai.domain.agent.service.util.OpenAiUrlNormalizer.NormalizedUrl normalized =
                    cn.famecode.ai.domain.agent.service.util.OpenAiUrlNormalizer.normalize(apiHost, completionsPath);
            log.info("TaskBreakdownService 弱模型初始化: rawHost={}, rawPath={}, normalizedBaseUrl={}, normalizedCompletionsPath={}, model={}",
