package cn.famecode.ai.domain.agent.service.subagent;
...
/**
 * 子代理管理器（对标 FameCode agentService.ts + executeSubAgent）
 * <p>
 * 三类内置子代理：
...
public class SubAgentManager {
    ...
    private String buildAgentSystemPrompt(AgentDefinition agentDef) {
        ...
        sb.append("你是 FameCode 的").append(agentDef.getDescription()).append("。你正在执行一个子任务。\n\n");
        sb.append("## 行为准则\n");
