package cn.famecode.ai.cases.react.factory;
...
public class DefaultReActFactory {
    ...
    public static class DynamicContext {
        ...
        private cn.famecode.ai.api.dto.ProjectContextDTO projectContext;

        /** SSE 事件发射器 */
        private ResponseBodyEmitter emitter;

        // ══════════════════════════════════════════════════════════
        //  消息历史（参考 FameCode streamingAgent.ts）
        ...
        /** 最终结果 DTO */
        private cn.famecode.ai.api.dto.ReActResultDTO result;

        // ══════════════════════════════════════════════════════════
        //  工具定义（参考 FameCode ai.ts）
        // ══════════════════════════════════════════════════════════
        ...
        private cn.famecode.ai.domain.agent.service.engine.LoopState loopState;
