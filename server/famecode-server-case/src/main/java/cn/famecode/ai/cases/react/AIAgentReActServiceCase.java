package cn.famecode.ai.cases.react;

import cn.famecode.ai.api.dto.ChatRequestDTO;
import cn.famecode.ai.api.dto.ReActResultDTO;
import cn.famecode.ai.cases.IAIAgentReActServiceCase;
import cn.famecode.ai.cases.react.engine.AgentLoopExecutor;
import cn.famecode.ai.cases.react.factory.DefaultReActFactory;
import cn.famecode.ai.cases.react.node.RootNode;
import cn.famecode.ai.domain.agent.service.engine.AgentLoopConfig;
                ...
                while (!dynamicContext.isCancelled() && streamThread.isAlive()) {
                    try {
                        ...
                        if (!dynamicContext.isCancelled() && streamThread.isAlive()) {
                            ...
                            cn.famecode.ai.domain.agent.service.engine.LoopState ls = dynamicContext.getLoopState();
                            if (ls != null) {
                                ls.touch();
                            }
                        }
